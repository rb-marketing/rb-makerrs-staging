        ...
        <div className="container">
          <div className="cs-content max-w-[914px] md:mb-20">
            <div className="mt-9 md:mb-20">
              ...
              <p className="text-base md:text-2xl text-rb-black/80 !leading-[150%] mb-8">
                In the rich fabric of India&apos;s handloom traditions, Project
                LooM, led by author and journalist Shoba Narayan, emerges as a
                beacon for artisans working tirelessly in anonymity.
                Commissioned by Taniera, a Titan company, the project aims to
              ...
              <p className="text-base md:text-2xl text-rb-black/80 !leading-[150%] mb-8">
                ...
                Creating these stories across the country - with each having
                their own flavour, inspired by the handloom and the region.
              </p>
            </div>
            <div className="mt-6 md:mt-20 md:mb-20">
              ...
              <p className="text-base md:text-2xl text-rb-black/80 !leading-[150%] mb-[30px]">
                ...
                meeting artisans and art historians, asking questions, and
              ...
              <p className="text-base md:text-2xl text-rb-black/80 !leading-[150%] mb-[30px]">
                ...
                documentary films, each unravelling a unique intricate handloom
                process from inception to completion. We traversed locations
                that have a rich history of weaving traditions and weaver
                collectives, bringing to life the untold stories of India’s
                weaving traditions and the handlooms that today’s consumers
                cherish.
              </p>
            </div>
          </div>
