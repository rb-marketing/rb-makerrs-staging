...
const pageData = {
  ...
  image: '/img/works/vymo-lead-management-banner.webp',
    ...
    sources: [
      {
        ...
        duration: 130,
        vimeoId: '894997404',
        name: 'Vymo for Financial Institutions',
        company: 'Vymo',
        thumbnail: {
          width: 446,
          height: 265,
          src: '/img/case-study/vymo-lead-management-video.webp',
        },
      },
    ],
  },
  ...
  return (
    <>
      <SEO
        ...
        url="https://www.makerrs.com/work/brand-campaign/vymo-lead-management"
      />
      <WorkHeroSection
        logo={logo}
        socials={socials}
        tags={tags}
        title="A Lead Management Product for Financial Services"
          ...
          <div className="cs-content max-w-[914px]">
            <div className="mt-9 md:mb-20">
              <p className=" mb-6 md:mb-7.5 !leading-[150%]">
                Vymo’s lead management feature helps financial institutions
                track, nurture, and convert leads with ease. To showcase its
                impact, we crafted a dynamic marketing video, refining the
                script, casting with precision, and blending seamless
                transitions with custom graphics. Produced efficiently in
                Bangalore with a global appeal, the film delivers a compelling
                story that resonates with financial teams. We worked closely
                with the client in enhancing scripts, visualizing in a
                contextually-relevant manner, and running efficient production
