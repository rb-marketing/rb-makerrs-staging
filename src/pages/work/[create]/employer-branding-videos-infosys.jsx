...
export const stats = [
  {
    ...
    text: <span className="md:max-w-[188px]">films produced</span>,
  },
  {
    id: 1,
    countUpProps: {
          ...
          <div className="cs-content max-w-[914px]">
            <div className="mt-9 md:mb-20">
              ...
              <p className=" mb-6 md:mb-7.5 !leading-[150%]">
                As one of the world’s leading technology consulting firms,
                Infosys has grown from its roots in India to a global presence
                spanning 54 countries and over 300,000 employees. But with the
                expansion came a new brand challenge - to attract local talent
                in international regions.
              </p>
              <p className=" mb-6 md:mb-7.5 !leading-[150%]">
                To solve this challenge, Infosys needed a global Employer
                Branding campaign positioning itself as a global employer. The
                campaign had to be insight-led with powerful and real narratives
                to help shift the brand perception and attract local talent.
              </p>
              <p className=" mb-6 md:mb-7.5 !leading-[150%]">
                We crafted 16 compelling employee-led films - shot in London,
                Paris, New York, Melbourne, and Richardson - all in 45 days.
              </p>
            </div>
            <div className="mt-9 md:mb-16">
              ...
              <p className="mb-6 md:mb-7.5 !leading-[150%]">
                To bring alive truthful narratives from across continents, we
                first met dozens of employees and curated campaign voices. Our
                first week or two were spent in meetings to understand the
                people at Infosys, learn about their careers and experiences at
                work, and then craft 16 unique scripts - one for every
                individual we would feature in the campaign.
              </p>
              <p className="mb-6 md:mb-7.5 !leading-[150%]">
                In parallel, our Directorial and Design teams created a unique
                Instagram- and LinkedIn-friendly campaign look and feel. A
                treatment that would lend a unique yet consistent look and feel
                across all 16 videos and their adapts, yet bring through
                individual narratives and in a short turnaround time.
              </p>
            </div>
            ...
            <div className="mt-9 md:mt-20 md:mb-16 ">
              ...
              <p className="md:text-xl text-rb-black/70 !leading-[170%] mb-6 md:mb-[30px]">
                To deliver at the speed and scale required for this global
                campaign, we leveraged our global collaborative of curated
                directors, producers, and cinematographers. We briefed
                hand-picked video crews in London, Paris, New York, Melbourne,
                and Richardson. Each local crew was briefed on the cultural
                context, campaign purpose and aesthetics - with the Creative
                Direction, production coordination, project management and post
                production happening in our India office.
              </p>
              <p className="md:text-xl text-rb-black/70 !leading-[170%] mb-6 md:mb-[30px]">
                Nearly 40 individuals contributed across locations - writers,
                directors, producers, editors, project managers, and account
                leads - all working as one global team. The result: a
                consistent, scaled, and culturally rich campaign, powered by a
                precise process and our creative cloud platform.
              </p>
              <p className="md:text-xl text-rb-black/70 !leading-[170%] mb-6">
                Together, we brought alive the campaign’s core idea - to capture
                and share authentic, emotionally resonant stories - each
                spotlighting an Infosys employee and their professional journey
                at Infosys.
              </p>
            </div>
            ...
            <div className="mt-9 md:mt-20 md:mb-16 ">
              ...
              <p className="md:text-xl text-rb-black/70 !leading-[170%] mb-6 md:mb-[30px]">
                The project plan was built on six weeks of tightly managed
                execution - mapped down to the day.
              </p>
              <p className="md:text-xl text-rb-black/70 !leading-[170%] mb-6 md:mb-[30px]">
                Week 1–2: We kicked off with research into global talent trends
                and employer branding benchmarks for tech consulting brands. In
                parallel, we finalized campaign concepts, created visual
                references, and developed a powerful creative framework to
                ensure consistency across all locations.
              </p>
              <p className="md:text-xl text-rb-black/70 !leading-[170%] mb-6 md:mb-[30px]">
                Week 2–3: Our teams conducted pre-interviews with all 16 Infosys
                speakers, developed detailed talking points and story outlines,
                and locked scripts. We also designed motion graphic templates
                and defined graphic assets to be used across all videos in the
                series.
              </p>
              <p className="md:text-xl text-rb-black/70 !leading-[170%] mb-6 md:mb-[30px]">
                Week 3–4: Our production team reached out to local crews in all
                5 global locations for the remote shoots. They were briefed on
                scripts, visual language, interview styles, and cultural
                nuances. Soon after, local recces were completed. We shot across
                5 global locations where every shoot was remotely directed by
                Makerrs’s creative leadership, providing real-time feedback for
                tight quality control. Despite spanning five time zones, the
                process remained smooth - no footage lost, no brief
                misunderstood.
              </p>
              <p className="md:text-xl text-rb-black/70 !leading-[170%] mb-6 md:mb-[30px]">
                Week 4–5: With footage from all five countries rolling in, we
                initiated post-production at our in-house studio. To make this
                process easier and incorporate client reviews at every stage, we
                used cloud-based workflows and asynchronous editing. We also
                handled versioning, audio mixing, color grading, and approvals
                across locations efficiently.
              </p>
              <p className="md:text-xl text-rb-black/70 !leading-[170%] mb-6 md:mb-[30px]">
                Week 6: The final videos, each 1-minute in length with
                supporting 30-second social edits were finalized and delivered -
                a full five working days ahead of the 45-day deadline
              </p>
              <p className="md:text-xl text-rb-black/70 !leading-[170%] mb-[36px]">
                Throughout the project, we managed the end-to-end execution -
                from research, pre-interviews, scriptwriting, design & graphics,
                crew curation, remote direction, global shoot management,
                editing & sound, color correction, versioning, cloud-based
                feedback, to full client servicing across time zones.
              </p>
            </div>
          </div>
